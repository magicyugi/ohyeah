<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="NEWTilePanel.aspx.cs" Inherits="AppBox.NewTilePanel" %>
        ...
        <div class="navbar-inner">
            <div class="container-fluid">
                ...
                <div class="navbar hor-menu hidden-phone hidden-tablet">
                    <div class="navbar-inner">
                        <ul class="nav">
                            ...
                            <li class="active"><a href="#">客户分层 <span class="selected"></span></a>
                            </li>
                            <li><a href="#">事务中心 <span class="selected"></span></a>
                            </li>  
                            <li ><a href="#">数据分析 <span class="selected"></span></a>
                            </li>
                             <li ><a href="#">系统设置 <span class="selected"></span></a>
                            </li>
                           <%--
                ...
                <ul class="nav pull-right">
                    <li><a id="menuflag" href="View/MainBill/MainBills.aspx"><i class="icon-key"></i>数据分析</a></li>
   ...
   <script>
    ...
    <div class="page-content" style="margin-top: 42px;">
		...
		<div class="portlet-title"> 
            ...
            <div class="portlet-body">
                <!--BEGIN TABS-->
                <div class="tabbable tabbable-custom">
                    <ul class="nav nav-tabs" id="panelul">
                        <li class="active" url="View/MainBill/MainBills.aspx"><a href="#tab_1" data-toggle="tab">
                            数据分析</a></li>
                    </ul>
    ...
    <script>
        jQuery(document).ready(function () {
            $(".submit").click(function () { alert(123); });
