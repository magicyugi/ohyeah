<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="HorzontalTilePanel.aspx.cs" Inherits="AppBox.HorzontalTilePanel" %>
		...
		<div class="navbar-inner">
			...
			<div class="container-fluid">
                ...
                <div class="navbar hor-menu hidden-phone hidden-tablet">
					...
					<div class="navbar-inner">
                     <ul id="Menudiv" class="nav" runat="server">
		...
		<div class="portlet-body">
			...
			<div class="tabbable tabbable-custom">
				...
				<ul class="nav nav-tabs" id="panelul">
					...
					<li  class="active" url="TileContent.aspx"><a href="#tab_1" data-toggle="tab">数据分析</a></li> 
				...
				<div class="tab-content" id="panelcontent">
					...
					<div class="tab-pane active" id="tab_1">
						...
						<iframe src="TileContent.aspx"  frameBorder=0 width="100%" height="620px" ></iframe>
