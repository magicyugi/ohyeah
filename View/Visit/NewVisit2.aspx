<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="NewVisit2.aspx.cs"
    Inherits="AppBox.View.Visit.NewVisit2" %>
     <%-- **********************售后******************************--%>
    ...
    <div id="winProcess" class="easyui-window" data-options="title:'进度设置',modal:true,closed:true,iconCls:'icon-save',collapsible:false,minimizable:false"
        ...
        <form name="formReason" id="form1" status="reason">
            ...
            data-options=" 
                ...
                method: 'get', 
                view:groupview,
                url: 'Ajax.aspx?type=PGrid&category=2&code=' + request('code'),
